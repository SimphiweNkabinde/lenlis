export default function LoadingPage() {
    return (
        <>
            <div className="border-b-1 pt-4 px-5 flex flex-col gap-3 h-32 animate-pulse">
            ...
            <ul className="list-outside px-5 flex flex-col gap-7 overflow-y-scroll pt-5 pb-10  animate-pulse">
