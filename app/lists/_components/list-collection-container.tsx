...
export default function ListCollectionContainer({ listCollection = [], emptyTitle = "", emptySubtitle = "" }: { listCollection?: { id: string, name: string, createdAt: string, members: number }[], emptyTitle?: string, emptySubtitle?: string }) {
    ...
    return (
        <ul className="flex flex-col gap-4">
            {listCollection.map(list => (
                <li className="px-4 py-1 hover:bg-muted/50">
