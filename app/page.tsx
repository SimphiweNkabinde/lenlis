        ...
        {(!lists || !lists.length) &&
          <div className="h-full flex flex-col items-center justify-center flex-1">
            <div className="flex flex-col items-center gap-2">
              ...
              <div className="font-semibold lg:font-medium lg:text-lg text-xl">No lists yet</div>
              <div className="text-current/50 text-lg lg:text-base text-center">All your lists will appear here</div>
            </div>
          </div>
        }
        {(lists && lists.length) &&
